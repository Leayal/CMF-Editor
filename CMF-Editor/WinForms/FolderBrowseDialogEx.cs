/*
 * Code from https://github.com/Leayal/Leayal.Forms/blob/master/Forms/FolderBrowseDialogEx.cs
*/
...
#pragma warning restore 414
        ...
        public bool? ShowDialog(Window parent)
        {
            ...
            bool? result = null;
            string re = this.SelectFolder(this.Description, (new WindowInteropHelper(parent)).Handle);
